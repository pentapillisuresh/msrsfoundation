    ...
    <footer className="bg-dark text-white pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/csr-projects" className="text-gray-400 hover:text-secondary">CSR Projects</Link></li>
              <li><Link to="/donate" className="text-gray-400 hover:text-secondary">Donate Now</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-secondary">
                <FiFacebook />
              </a>
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-secondary">
                <FiTwitter />
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {year} MAHA SHREE RUDRA SAMSTHANAM FOUNDATION. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
