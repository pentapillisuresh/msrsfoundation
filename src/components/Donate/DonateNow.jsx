...
import { 
  ...
  FiDroplet, FiAward, FiCalendar, FiArrowRight, FiCheckCircle
} from 'react-icons/fi';
import { 
            ...
            <div className="sticky top-24 space-y-6">
              <div className="bg-white border border-[#EAF6E3] overflow-hidden" data-aos="fade-left">
                ...
                <div className="p-5 space-y-4">
                  ...
                  <button className="w-full bg-[#2C3E2B] hover:bg-[#1a261a] text-white font-bold py-3 text-sm transition-all flex items-center justify-center gap-2 mt-3">
